...
import drillPerformanceRepository from './repositories/drill-performance.repository.js';
import {
...
export async function getNextDrill(params: {
  type: string;
  maxBase?: unknown;
  userId: unknown;
...
export async function verifyDrill(params: {
  type: unknown;
  userAnswer: unknown;
