...
export const EXAM_PROFILES: Record<string, ExamProfile> = {
  ssc: {
    ...
    mockQuestions: 100,
    mockMinutes: 60,
    /** Per-section Q count for a proper full mock (matches mock bank sections) */
    mockSectionLimits: { English: 25, GK: 25, Quant: 25, Reasoning: 25 },
  ...
  banking: {
    ...
    mockQuestions: 100,
    mockMinutes: 60,
    mockSectionLimits: { English: 30, Quant: 35, Reasoning: 35, GA: 0 },
  ...
  railways: {
    ...
    mockQuestions: 100,
    mockMinutes: 90,
    mockSectionLimits: { Maths: 30, Reasoning: 30, GK: 25, 'General Science': 15 },
  ...
  upsc: {
    ...
    mockQuestions: 100,
    mockMinutes: 120,
    mockSectionLimits: { 'GS Paper I': 100, CSAT: 0 },
  ...
  cat: {
    ...
    mockQuestions: 66,
    mockMinutes: 120,
    mockSectionLimits: { VARC: 24, DILR: 20, Quant: 22 },
  ...
  state_psc: {
    ...
    mockQuestions: 150,
    mockMinutes: 120,
    mockSectionLimits: { GS: 50, Aptitude: 40, 'State GK': 35, Language: 25 },
    marking: { correct: 1, wrong: -0.25, unattempted: 0 },
  ...
  other: {
    ...
    mockQuestions: 100,
    mockMinutes: 60,
    mockSectionLimits: { 'Section A': 25, 'Section B': 25, 'Section C': 25, 'Section D': 25 },
...
export function getExamProfile(id?: string | null): ExamProfile {
