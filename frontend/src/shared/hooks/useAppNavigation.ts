...
export interface NavigationOptions extends PathContext {}

/**
 * URL-driven navigation — reload keeps you on the same page.
 */
export function useAppNavigation(ctx: PathContext = {}) {
  ...
  const goToView = useCallback(
    (view: string, options: NavigationOptions = {}) => {
      const merged: PathContext = {
