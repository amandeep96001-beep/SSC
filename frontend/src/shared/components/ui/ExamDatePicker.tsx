import { useMemo, useState, useEffect, useId, useRef, type CSSProperties } from 'react';
...
type CalendarCell = CalendarPadCell | CalendarDayCell;
...
export function ExamDatePicker({
  ...
  return (
    <div className="edp-simple" style={{ '--edp-accent': accent } as CSSProperties} ref={rootRef}>
