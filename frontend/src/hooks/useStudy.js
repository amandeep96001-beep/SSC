...
export function useStudy() {
  ...
  return {
    ...
    testSummary,
    user,
    loading: getSubjectsApi.loading || getTopicsApi.loading || getNotesApi.loading || getTestApi.loading || addTopicApi.loading || loginApi.loading || registerApi.loading || updateTopicApi.loading || deleteTopicApi.loading,
    error: getSubjectsApi.error || getTopicsApi.error || getNotesApi.error || getTestApi.error || addTopicApi.error || loginApi.error || registerApi.error || updateTopicApi.error || deleteTopicApi.error,
    skipToSubjects,
    selectSubject,
    selectTopic,
    startTest,
