...
interface RevisionWorkspaceProps {
  deckTab: string;
  setDeckTab: Dispatch<SetStateAction<string>>;
  tableSubTab: string;
  setTableSubTab: Dispatch<SetStateAction<string>>;
  expandedTable: number | null;
  setExpandedTable: Dispatch<SetStateAction<number | null>>;
  vocabSearch: string;
  setVocabSearch: Dispatch<SetStateAction<string>>;
  vocabCategory: string;
  setVocabCategory: Dispatch<SetStateAction<string>>;
  vocabListLoading: boolean;
  filteredVocabDB: VocabItem[];
  setVocabModalOpen: Dispatch<SetStateAction<boolean>>;
  openEditVocab: (item: VocabItem) => void;
  loadVocabList: (page?: number, searchStr?: string, categoryStr?: string) => void;
  vocabModalOpen: boolean;
  editingVocabId: string | null;
  vocabForm: VocabFormState;
  setVocabForm: Dispatch<SetStateAction<VocabFormState>>;
  handleVocabSubmit: (e: FormEvent) => void;
  vocabFormError: string;
  vocabFormSuccess: string;
  resetVocabForm: () => void;
  vocabBulkModalOpen: boolean;
  setVocabBulkModalOpen: Dispatch<SetStateAction<boolean>>;
  vocabBulkJson: string;
  setVocabBulkJson: Dispatch<SetStateAction<string>>;
  vocabBulkError: string;
  vocabBulkSuccess: string;
  handleVocabBulkSubmit: (e: FormEvent) => void;
  vocabPage: number;
  vocabTotalPages: number;
  handleVocabPageChange: (newPage: number) => void;
}
