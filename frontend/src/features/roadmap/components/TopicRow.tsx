...
import { STATUS_LABELS, TOPIC_STATUS, type SyllabusTopic } from '../data/syllabus';
import { Check, Circle, StickyNote, Loader } from 'lucide-react';
import type { TopicProgress } from '../hooks/useRoadmapProgress';
import type { TopicStatus } from '../data/syllabus';
...
export function TopicRow({
  ...
  const status: TopicStatus = entry?.status || TOPIC_STATUS.PENDING;
