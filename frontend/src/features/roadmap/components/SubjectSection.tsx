...
import { TOPIC_STATUS, type SyllabusSubject, type SyllabusTopic } from '../data/syllabus';
import type { SubjectProgressStats, TopicProgress } from '../hooks/useRoadmapProgress';

interface SubjectWithIcon extends SyllabusSubject {
  _Icon?: ComponentType<{ size?: number; strokeWidth?: number }>;
}

interface SubjectSectionProps {
  subject: SubjectWithIcon;
  subjectStats?: SubjectProgressStats;
  expanded: boolean;
  onToggleExpand: () => void;
  getTopic: (topicId: string) => TopicProgress;
  onToggle: (topicId: string) => void;
  onCycleStatus: (topicId: string) => void;
  onOpenNotes: (topic: SyllabusTopic) => void;
  filterStatus: string;
  searchQuery: string;
}
